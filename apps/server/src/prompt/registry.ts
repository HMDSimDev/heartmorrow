...
const GUARDRAIL_META: Record<string, { const: string } & RegistryMeta> = {
  ...
  WELCOME_INTRO_GUARDRAILS: { const: WELCOME_INTRO_GUARDRAILS, label: 'Onboarding welcome intro', category: 'creator', purpose: 'Onboarding: writes the warm, second-person welcome shown as the player steps into a new world.' },
